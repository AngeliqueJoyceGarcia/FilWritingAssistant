...
class AppInfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //for side menu
        val sidemenu = findViewById<ImageView>(R.id.btnSideMenu4)
        ...
        drawer = findViewById(R.id.appinfoparent)
            ...
            if (email != null){
                database.child("Profiles").orderByChild("email").equalTo(email).addListenerForSingleValueEvent(object :
                    ...
                    override fun onCancelled(error: DatabaseError) {
                        Toast.makeText(this@AppInfoActivity, "Failed to retrieve data from database", Toast.LENGTH_SHORT).show()
                    }
                })
            }
        }
